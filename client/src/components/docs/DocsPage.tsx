        ...
        <div className="space-y-8 text-zinc-300">
          <div className="rounded-2xl border border-blue-500/20 bg-blue-500/5 p-6 backdrop-blur-md">
            <h3 className="text-xl font-semibold text-white mb-2 flex items-center gap-2">
              <Sparkles className="text-blue-400 h-5 w-5" /> Executive Summary
            </h3>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-5 rounded-xl border border-white/10 bg-white/[0.03] space-y-2">
          ...
          <div>
            ...
            <div className="p-6 rounded-xl border border-white/10 bg-zinc-950 font-mono text-xs text-zinc-300 space-y-3 leading-relaxed">
      ...
      content: (
        <div className="space-y-6 text-zinc-300">
          ...
          <div className="space-y-4">
            ...
            <div className="relative rounded-xl border border-white/10 bg-zinc-950 p-4 font-mono text-xs overflow-x-auto text-emerald-400">
        ...
        <div className="space-y-6 text-zinc-300">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl border border-white/10 bg-white/[0.02] space-y-2">
              ...
              <p className="text-xs text-zinc-400">Queries NVD API with automatic local caching and fallback to local CVE databases to prevent API rate limits.</p>
            </div>
            ...
            <div className="p-4 rounded-xl border border-white/10 bg-white/[0.02] space-y-2">
              ...
              <p className="text-xs text-zinc-400">Maps CWE identifiers (e.g. CWE-89, CWE-78) to MITRE techniques like T1190 (Exploit Public-Facing Application).</p>
            </div>
            ...
            <div className="p-4 rounded-xl border border-white/10 bg-white/[0.02] space-y-2">
              ...
              <p className="text-xs text-zinc-400">Calculates business risk based on CVSS severity, node centrality, and internet exposure reachability.</p>
            </div>
          </div>
        </div>
      ),
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-xl border border-rose-500/20 bg-rose-500/5 space-y-2">
              <div className="flex items-center justify-between">
                <h4 className="text-base font-semibold text-rose-300 flex items-center gap-2">
                  <AlertTriangle size={18} /> Stage 1: Offense Agent (Red Team)
                </h4>
                <span className="text-[10px] font-mono uppercase bg-rose-500/20 text-rose-300 px-2 py-0.5 rounded">Threat Simulation</span>
              </div>
            ...
            <div className="p-5 rounded-xl border border-blue-500/20 bg-blue-500/5 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono uppercase bg-blue-500/20 text-blue-300 px-2 py-0.5 rounded">Patch Formulator</span>
              </div>
              <p className="text-xs text-zinc-300 leading-relaxed">
            ...
            <div className="p-5 rounded-xl border border-purple-500/20 bg-purple-500/5 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono uppercase bg-purple-500/20 text-purple-300 px-2 py-0.5 rounded">Audit Synthesis</span>
              </div>
              <p className="text-xs text-zinc-300 leading-relaxed">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6 text-zinc-300">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-5 rounded-xl border border-white/10 bg-zinc-950 space-y-2">
          ...
          <div className="space-y-4">
            <div className="p-5 rounded-xl border border-white/10 bg-white/[0.02] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded">Indian Regulation</span>
              </div>
              <p className="text-xs text-zinc-400 leading-relaxed">
            ...
            <div className="p-5 rounded-xl border border-white/10 bg-white/[0.02] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-blue-400 bg-blue-500/10 px-2 py-0.5 rounded">Indian Cyber Mandate</span>
              </div>
              <p className="text-xs text-zinc-400 leading-relaxed">
            ...
            <div className="p-5 rounded-xl border border-white/10 bg-white/[0.02] space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-bold text-purple-400 bg-purple-500/10 px-2 py-0.5 rounded">BFSI & Enterprise</span>
              </div>
              <p className="text-xs text-zinc-400 leading-relaxed">
    ...
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black">
      ...
      <div className="max-w-7xl mx-auto pt-28 pb-24 px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-12 text-center md:text-left flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-8">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-300 text-xs font-mono uppercase tracking-wider mb-3">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-zinc-900/80 border border-white/10 rounded-xl text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-blue-500 transition-colors"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            {filteredSections.map((section) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full flex items-start gap-3 p-3.5 rounded-xl text-left transition-all duration-200 cursor-pointer border",
                    isActive
          ...
          <div className="lg:col-span-8 xl:col-span-9 bg-zinc-900/40 border border-white/10 rounded-2xl p-6 md:p-10 backdrop-blur-xl">
            <div className="flex items-center justify-between border-b border-white/10 pb-6 mb-8">
              ...
              <div className="hidden sm:flex items-center gap-2">
                ...
                <span className="text-xs font-mono text-zinc-400">v1.4 Production Verified</span>
              </div>
            </div>
