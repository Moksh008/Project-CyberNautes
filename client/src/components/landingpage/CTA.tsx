...
export const CTA = () => {
  ...
  return (
    <section className="relative py-32 md:py-44 border-t border-slate-900 bg-[#05070a] overflow-hidden min-h-[650px] flex items-center justify-center text-center font-sans">
      ...
      <div className="relative z-10 px-8 flex flex-col items-center max-w-3xl">
        <motion.div {...fadeUp(0)} className="relative w-16 h-16 flex items-center justify-center mb-10">
          <div className="absolute inset-0 rounded-2xl glass-panel" />
        ...
        <motion.p {...fadeUp(0.2)} className="text-slate-300 text-lg mb-12 max-w-xl mx-auto leading-relaxed">
        ...
        <motion.div {...fadeUp(0.3)} className="flex flex-col sm:flex-row gap-3">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="glass-pill text-white/70 hover:text-white font-medium rounded-full px-10 py-4 text-sm tracking-wide transition-all"
          >
            Read the Docs
          </motion.button>
        </motion.div>
